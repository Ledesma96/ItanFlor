          ...
          <form ref={form} onSubmit={handleSubmit} id="form" className="contact__main__form" action="">
            <div className='divInputs'>
              <div className="contact__main__form__boxes">
                <label className='contact__main__form__boxes__label' htmlFor="nombre">Nombre</label>
                <input onChange={(e) => setName(e.target.value)} name="name" className="transparencia input" type="text" placeholder="Nombre" required/>
              </div>
              <div className="contact__main__form__boxes">
                <label className='contact__main__form__boxes__label' htmlFor="nombre">Apellido</label>
            ...
            <div className='divInputs'>
              <div className="contact__main__form__boxes">
                <label className='contact__main__form__boxes__label' htmlFor="apellido">Teléfono</label>
              ...
              <div className="contact__main__form__boxes">
                <label className='contact__main__form__boxes__label' htmlFor="email">Email</label>
            ...
            <div className="contact__main__form__boxes div_message">
                <label className='contact__main__form__boxes__label' htmlFor="mensaje">Mensaje</label>
